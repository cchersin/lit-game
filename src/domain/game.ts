...
const whiteCards = [
    ...
    new Card('13', 'carrellino per paraplegici', 'white'),
    new Card('14', 'Martina', 'white'),     
    new Card('15', 'il Nordio', 'white'),     
    new Card('16', 'bagni unisex', 'white'),   
    new Card('17', 'malattie veneree di Freddie Mercury', 'white'),       
    ...
    new Card('31', 'Giustizia Britannica', 'white'),   
    ...
    new Card('60', 'Genitore 1', 'white'),     
    new Card('61', 'Genitore 2', 'white'),   
    new Card('62', 'Genitore 3', 'white'),
    ...
    new Card('70', 'grigio cadavere di Steve Jobs', 'white'),     
    ...
    new Card('76', 'testate nucleari a corta gittata', 'white'),
    ...
    new Card('80', 'Ovovia Galattica', 'white'),     
    ...
    new Card('87', 'Genitore 2 e 3/4', 'white'),
    ...
    new Card('122', 'onion rings', 'white'), 
    ...
    new Card('146', 'bambini africani', 'white'),
    ...
    new Card('156', 'white privilege', 'white'),
    ...
    new Card('163', 'pessime scelte di vita', 'white'),
...
const blackCards = [
    ...
    new Card('42', 'Sono Giorgia. Sono una donna. Sono una madre. Sono ______.', 'black') ,
